...
################################################################################
# Grid Engine options
#$ -N USUV_2024Aug28_alldata_aligned_formatted_noFLI_ns5_9100-9600.fasta
#$ -cwd
#$ -pe sharedmem 4
#$ -l h_vmem=16G
#$ -l h_rt=48:00:00
...
iqtree2 -s USUV_2024Aug28_alldata_aligned_formatted_noFLI_ns5_9100-9600.fasta -bb 1000 -nt 4 -czb
echo '** Done **'
echo "============================================="
################################################################################
################################################################################
